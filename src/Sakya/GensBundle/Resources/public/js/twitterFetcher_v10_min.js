...
d++}else for(c=p(c,"tweet");d<c.length;)e.push(p(c[d],"e-entry-title")[0]),h.push(c[d].getAttribute("data-tweet-id")),g.push(p(c[d],"p-author")[0]),f.push(p(c[d],"dt-updated")[0]),0<p(c[d],"retweet-credit").length?a.push(!0):a.push(!1),d++;e.length>l&&(e.splice(l,e.length-l),g.splice(l,g.length-l),f.splice(l,f.length-l),a.splice(l,a.length-l));c=[];d=e.length;for(a=0;a<d;){if("string"!==typeof u){var b=new Date(f[a].getAttribute("datetime").replace(/-/g,"http://www.jcwebcreations.me/").replace("T"," ").split("+")[0]),b=u(b);
...
jQuery(document).ready(function($){
  ...
  var tweetID   = element.getAttribute('data-id'); //407202374847983616
  var numTweets = element.dataset.number;
  var i = 0;

  for (var i; i<numTweets.length; i++) {
    twitterFetcher.fetch(
      tweetID, // Your Twitter widget ID.
      'tweets', // The ID of the DOM element
      numTweets[i], // The maximum number of tweets you want returned.
      true, 
      false, 
      true, 
      dateFormatter, 
