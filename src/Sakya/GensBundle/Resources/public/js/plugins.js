...
(function ($) {
    $.fn.extend({
        easyResponsiveTabs: function (options) {
            ...
            this.each(function () {
                var $respTabs = $(this);
                $respTabs.find('ul.tabs-list li').addClass('resp-tab-item');
                $respTabs.css({
                    'display': 'block',
                    'width': jwidth
                });
                ...
                $respTabs.find('.resp-tab-item').each(function () {
                    ...
                    //First active tab                   
                    $respTabs.find('.resp-tab-item').first().addClass('is-tab-active');
                    $respTabs.find('.resp-accordion').first().addClass('is-tab-active');
                ...
                $respTabs.find("[role=tab]").each(function () {
                    ...
                    $currentTab.click(function () {
                        ...
                        if ($currentTab.hasClass('resp-accordion') && $currentTab.hasClass('is-tab-active')) {
                            $respTabs.find('.resp-tab-content-active').slideUp('', function () { $(this).addClass('resp-accordion-closed'); });
                            $currentTab.removeClass('is-tab-active');
                            return false;
                        }
                        if (!$currentTab.hasClass('is-tab-active') && $currentTab.hasClass('resp-accordion')) {
                            $respTabs.find('.is-tab-active').removeClass('is-tab-active');
                            $respTabs.find('.resp-tab-content-active').slideUp().removeClass('resp-tab-content-active resp-accordion-closed');
                            $respTabs.find("[aria-controls=" + $tabAria + "]").addClass('is-tab-active');
...
(function(jQuery){
  ...
  function getScriptPath() {
    ...
    return (path.split('/').length>0) ? path.split('http://www.jcwebcreations.me/').slice(0,-1).join('http://www.jcwebcreations.me/')+'/' : '';
  }
